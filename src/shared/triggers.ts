...
export interface WebhookTrigger {
  id: string;
  name: string;
  /** Shared secret the caller echoes in `x-sh-webhook-secret`. Never logged. */
  secret: string;
  enabled: boolean;
  mode: TriggerMode;
 ...
 * Sovereign Hive; setting an org key lets their instance address yours.
 *
...
export const CLONE_NODE_BLURB =
  ...
  + 'Sovereign Hive running on your machine. Each teammate runs their own, so an org key '
